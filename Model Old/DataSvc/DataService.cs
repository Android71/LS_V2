...
namespace LS_Designer_WPF.Model
{
    public class DataService : IDataService
    {
        ...
        public void GetControlSpaces(Action<ObservableNotifiableCollection<ControlSpace>, Exception> callback)
        {
            ControlSpace controlSpace;
            var x = new ObservableNotifiableCollection<ControlSpace>();
        ...
        public void GetEventDevices(ControlSpace space, Partition partition, Action<ObservableNotifiableCollection<EventDevice>, Exception> callback)
        {
            IEnumerable<EFData.EventDevice> y = null;
            var x = new ObservableNotifiableCollection<EventDevice>();
        ...
        public void GetPartitions(Action<ObservableNotifiableCollection<Partition>, Exception> callback)
        {
            var x = new ObservableNotifiableCollection<Partition>();
